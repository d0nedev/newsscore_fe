...
export const matches: Match[] = [
  ...
  {
    id: "che-rso-fr",
    leagueId: "persahabatan-klub",
    status: "finished",
    time: "20:00",
    date: "15.08.2026",
    round: "Persahabatan",
    venue: "Stadion Biru",
    home: team("chelsea", "Chelsea (Ing)", "CH"),
    away: team("sociedad", "Sociedad (Spa)", "SO"),
    score: [3, 1],
    halfTime: [2, 0],
    events: [],
    ...noDetail,
  },
  {
    ...
    date: "09.08.2026",
    round: "Persahabatan",
    venue: "Stadion Selatan",
    home: team("johor", "Johor DT (Mys)", "JO"),
    away: team("chelsea", "Chelsea (Ing)", "CH"),
    score: [3, 3],
    halfTime: [1, 2],
    events: [],
    ...noDetail,
